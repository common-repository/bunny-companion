...
$fasterly_theme_service_data 	= get_theme_mod('fasterly_theme_service_data',fasterly_service2_default());
if($fasterly_theme_hs_service=='1'):
?>	
<section id="service-section" class="service_section_6 hm-service fs-py-default">
	<div class="container">
		...
		<div class="row service-wrp">
			...
			?>
				<div class="col-lg-4 col-md-6 wow fadeInUp mb-4">
					<div class="service-style-6">
					  <div class="service-item-6">
						 <div class="service-box-content">
							<?php if ( ! empty( $icon )  || ! empty( $image )) : ?>
								<div class="bn-service-icon">
								   <div class="bn-service-icon-wrapper">
									  <div class="pbmit-services-circle-wrapper">
										 <div class="pbmit-services-circle"></div>
									  </div>
									  <div class="pbmit-services-circle-wrapper">
										 <div class="pbmit-services-circle"></div>
									  </div>
							...
							<div class="pbminfotech-box-content-inner">
								<?php if ( ! empty( $title ) ) : ?>
								   <h3 class="pbmit-service-title"><a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?> </a></h3>
							   <?php endif; ?>	
							   ...
							   <?php endif; ?>	
							    ...
							    <?php if ( ! empty( $link ) ) : ?>
								   <div class="pbmit-service-btn"> 
									  <a class="round-btn" href="<?php echo esc_url($link); ?>">
