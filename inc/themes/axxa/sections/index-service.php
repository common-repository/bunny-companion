...
?>	
<section id="service-section" class="service_section_8 wow fadeInUp hm-service fs-py-default">
	<div class="container">
				...
				<div class="col-lg-3 col-md-6 mb-4 wow fadeInUp">
					<div class="services-two__single">
						...
						<div class="services-two__content">
							<?php if ( ! empty( $title ) ) : ?>
								<h3 class="services-two__title"><a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?></a></h3>
							<?php endif; ?>	
							
							<?php if ( ! empty( $text ) ) : ?>
								<p class="services-two__text"><?php echo esc_html($text); ?> </p>
							<?php endif; ?>	
							
							<?php if ( ! empty( $button ) ) : ?>
								<a href="<?php echo esc_url($link); ?>"><?php echo esc_html($button); ?>  <i class="fa fa-angle-double-right"></i></a>
							<?php endif; ?>		
						</div>
						<div class="services-two__hover-single">
							<?php if ( ! empty( $image ) ) : ?>
								<div class="services-two__hover-img" style="background-image: url(<?php echo esc_url($image); ?>);">
								</div>
							<?php endif; ?>	
							<div class="services-two__hover-content-box">
								...
								<div class="services-two__hover-content">
									<?php if ( ! empty( $title ) ) : ?>
										<h3 class="services-two__hover-title"><a href="<?php echo esc_url($link); ?>"><?php echo esc_html($title); ?></a></h3>
									<?php endif; ?>	
									
									<?php if ( ! empty( $text ) ) : ?>
										<p class="services-two__hover-text"><?php echo esc_html($text); ?> </p>
									<?php endif; ?>	
									<?php if ( ! empty( $button ) ) : ?>
