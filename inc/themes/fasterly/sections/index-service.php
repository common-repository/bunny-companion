...
?>	
<section id="service-section" class="service_section_1 hm-service">
	<div class="container">
		...
		<div class="row service-wrp">
			...
			?>
				<div class="col-lg-3 col-md-6 wow fadeInUp mb-4">
					<div class="service_box">
						...
						<div class="service_Content">
							...
							<?php endif; ?>	
							<span class="bd-service_big_text"><?php esc_html_e('0','bunny-companion'); ?><?php echo esc_html($i+1); ?></span>
