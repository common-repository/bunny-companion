...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	if( 'Axxa' == $Bunny_Companion_current_theme->name  || 'Fasco' == $Bunny_Companion_current_theme->name){
		$wp_customize->add_setting( FASTERLY_THEME_SETTINGS .'_service_data', 
			array(
			 'sanitize_callback' => 'fasterly_repeater_sanitize',
			 'priority' => 8,
			 'default' => fasterly_service3_default()
			)
		);
			...
			new Fasterly_Repeater( $wp_customize, 
				FASTERLY_THEME_SETTINGS .'_service_data', 
					array(
						...
						'item_name'                         => esc_html__( 'Service', 'bunny-companion' ),
		...
		$wp_customize->add_setting( FASTERLY_THEME_SETTINGS .'_service_data', 
			array(
			 'sanitize_callback' => 'fasterly_repeater_sanitize',
			 'priority' => 8,
			 'default' => fasterly_service_default()
			)
		);
