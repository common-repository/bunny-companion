...
?>	
<section id="service-section" class="service_section_7 hm-service fs-py-default">
	<div class="container">
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp mb-4">
					<div class="service_box">
						<div class="service_icon">
							<?php if ( ! empty( $icon ) ) : ?>
								<a href="<?php echo esc_url($link); ?>"><i class="fa <?php echo esc_attr($icon); ?>" aria-hidden="true"></i></a>
								<span></span>
							<?php endif; ?>	
							<div class="serial-number"><i class="fa fa-circle-thin" aria-hidden="true"></i>
								<i class="fa fa-circle-thin" aria-hidden="true"></i>
							</div>
						</div>
						<div class="service_Content">
							<?php if ( ! empty( $title ) ) : ?>
							   <h4 class="pbmit-service-title"><?php echo esc_html($title); ?> </h4>
						   <?php endif; ?>	
						   ...
						   <?php if ( ! empty( $button ) ) : ?>
								<div class="explore-btn">
									<a href="<?php echo esc_url($link); ?>">
										<span>
											<i class="fa fa-circle-thin icon-one" aria-hidden="true"></i>
											<i class="fa fa-long-arrow-right icon-two"></i>
										</span>
